...
export const BUILT_IN_THEMES: Record<BuiltInName, DraftTheme> = {
  ...
  kouji: {
    ...
    bg: {
      ...
      'bg-success':  'oklch(91% 0.21 124)',
      'bg-warning':  'oklch(78% 0.17 60)',
      'bg-danger':   'oklch(55% 0.22 20)',
    },
    fg: {
      'fg-default':     '#f0ede6',
  ...
  retro: {
    ...
    fg: {
      'fg-default':     '#282425',
      'fg-on-primary':  '#282425',
      'fg-on-accent':   '#282425',
      'fg-on-info':     '#282425',
      'fg-on-success':  '#282425',
      'fg-on-warning':  '#282425',
      'fg-on-danger':   '#ede5d0',
    },
  },
  ...
  cyberpunk: {
    ...
    fg: {
      ...
      'fg-on-accent':   '#ffee00',
      'fg-on-info':     '#0a0a0a',
      'fg-on-success':  '#0a0a0a',
      'fg-on-warning':  '#0a0a0a',
      'fg-on-danger':   '#0a0a0a',
    },
  },
