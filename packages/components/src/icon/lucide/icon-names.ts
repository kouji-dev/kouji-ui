...
// Top-level keys (kebab-case names) of the icon-nodes catalog.

/**
 * All Lucide icon kebab-case names from `lucide-static`. Useful for galleries,
 * autocomplete, or batch eager registration via {@link provideLucideIcons}.
 */
