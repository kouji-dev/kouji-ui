...
@Component({
  ...
  template: `
    <p>
      kouji-ui ships a small, opinionated set of components.
      Read the <kj-link kjHref="/docs" kjUnderline="always">documentation</kj-link>
      to get started, browse the
      <kj-link kjHref="https://github.com/kouji-dev/kouji-ui" kjTarget="_blank" kjUnderline="always">
        source on GitHub
      </kj-link>,
