...
describe('KjFieldComponent', () => {
  ...
  test('renders the kj-field host with class kj-field', () => {
    ...
    expect(
      fixture.nativeElement.querySelector('kj-field.kj-field'),
    ).not.toBeNull();
  });
  ...
  test('field-group renders prefix/suffix slots', () => {
    ...
    fixture.detectChanges();
    expect(
      fixture.nativeElement.querySelector('[data-test="prefix"]'),
    ).not.toBeNull();
    expect(
      fixture.nativeElement.querySelector('[data-test="suffix"]'),
    ).not.toBeNull();
    expect(
      fixture.nativeElement.querySelector('[data-test="input"]'),
    ).not.toBeNull();
  });
});
