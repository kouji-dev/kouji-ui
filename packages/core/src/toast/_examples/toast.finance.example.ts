...
@Component({
  ...
  template: `
    <div class="row">
      <button
        class="btn-success"
        (click)="toast.show('Transaction completed.', { variant: 'success' })"
      >
        Success
      </button>
      <button
        class="btn-error"
        (click)="toast.show('Payment declined.', { variant: 'destructive' })"
      >
        Error
      </button>
      <button
        class="btn-warning"
        (click)="toast.show('Session expiring soon.', { variant: 'warning' })"
      >
        Warning
      </button>
