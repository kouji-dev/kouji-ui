...
@Component({
  ...
  template: `
    <div class="grid">
      <div class="empty"></div>
      <button kjButton [kjVariant]="'default'" kjTooltipTrigger #tTop="kjTooltipTrigger">Top</button>
      <kj-tooltip-content [kjFor]="tTop" [kjSide]="'top'">Top tooltip</kj-tooltip-content>
      <div class="empty"></div>

      <button kjButton [kjVariant]="'default'" kjTooltipTrigger #tLeft="kjTooltipTrigger">Left</button>
      <kj-tooltip-content [kjFor]="tLeft" [kjSide]="'left'">Left tooltip</kj-tooltip-content>
      <div class="empty"></div>
      <button kjButton [kjVariant]="'default'" kjTooltipTrigger #tRight="kjTooltipTrigger">Right</button>
      <kj-tooltip-content [kjFor]="tRight" [kjSide]="'right'">Right tooltip</kj-tooltip-content>

      <div class="empty"></div>
      <button kjButton [kjVariant]="'default'" kjTooltipTrigger #tBot="kjTooltipTrigger">Bottom</button>
