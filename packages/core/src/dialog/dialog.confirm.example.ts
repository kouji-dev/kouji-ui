...
@Component({
  ...
  imports: [KjButton],
  styles: [`
    :host { display: block; background: var(--kj-surface); border: 1px solid var(--kj-border); border-radius: var(--kj-radius-lg); padding: 1.5rem; min-width: 22rem; color: var(--kj-text); font-family: var(--kj-font); box-shadow: var(--kj-shadow-hard); }
  ...
  template: `
    ...
    <div class="dialog-actions">
      ...
      <button kjButton [kjVariant]="'destructive'" (click)="ref.close('confirmed')">Yes, delete</button>
    </div>
  `,
})
