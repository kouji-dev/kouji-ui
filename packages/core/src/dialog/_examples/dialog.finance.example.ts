...
@Component({
  ...
  styles: [`
    :host { display: block; background: var(--kj-surface); border: 1px solid var(--kj-border); border-radius: var(--kj-radius-lg); padding: 1.5rem; min-width: 22rem; box-shadow: var(--kj-shadow-hard); font-family: var(--kj-font); color: var(--kj-text); }
    h2 { margin: 0 0 0.375rem; font-size: 1.0625rem; font-weight: 600; color: var(--kj-text); }
    .dialog-body { margin: 0 0 1.5rem; font-size: 0.875rem; color: var(--kj-text-muted); line-height: 1.6; }
    .dialog-actions { display: flex; gap: 0.5rem; justify-content: flex-end; }
    button { padding: 0.4rem 1rem; font-size: 0.8125rem; font-weight: 500; border-radius: var(--kj-radius-md); cursor: pointer; font-family: var(--kj-font); }
    .btn-cancel { background: var(--kj-surface); color: var(--kj-text); border: 1px solid var(--kj-border); }
    .btn-cancel:hover { background: var(--kj-bg); }
    .btn-primary { background: var(--kj-accent); color: var(--kj-accent-on); border: 1px solid var(--kj-accent); }
...
export class DialogFinanceExample {
  ...
  open() { this.dialog.open(DialogFinanceContent); }
}
