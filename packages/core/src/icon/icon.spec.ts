...
describe('KjIcon — svg mode (decorative default)', () => {
...
describe('KjIcon — meaningful mode (kjIconLabel)', () => {
...
describe('KjIcon — loader pending', () => {
