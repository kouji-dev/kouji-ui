...
Components: minor template adjustments in calendar / date-picker /
slider / time-picker so wrapper `.d.ts` two-way bindings type-check
against ng-packagr's narrowed signal types.
